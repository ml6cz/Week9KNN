...
kNN_acc
```
An 72.3% accuracy rate is okay but the base-rate is roughly 64/36, so we have more or less a 70% chance of guessing right if we don't know anything about the customer which is still slightly better than randomly guessing, but not optimal.
